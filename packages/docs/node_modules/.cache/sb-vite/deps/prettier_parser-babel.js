...
`);
        ...
        function zs(a, t, e, s, i, r, n, o, h, l) {
          ...
          for (let I = 0, C = r != null ? r : 1 / 0; I < C; ++I) {
        ...
        var Vr = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), O = class {
          ...
          unexpected(t, e) {
            throw this.raise(p.UnexpectedToken, { expected: e ? J(e) : null, at: t != null ? t : this.state.startLoc });
          }
          expectPlugin(t, e) {
            if (this.hasPlugin(t))
              return true;
            throw this.raise(p.MissingPlugin, { at: e != null ? e : this.state.startLoc, missingPlugin: [t] });
          }
          expectOnePlugin(t) {
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                ...
                let _e = this.flowParseObjectTypeProperty(C, d, x, w, N, i, n != null ? n : !c);
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
        ...
        var oa = (a) => class extends a {
          ...
          tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
            ...
            for (; ; ) {
              let { startLoc: l } = this.state, c = this.tsParseModifier(e.concat(s != null ? s : []), i);
              if (!c)
                break;
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      function D(a) {
        var _a;
        var s;
        let t = a.range ? a.range[0] : a.start, e = (_a = (s = a.declaration) == null ? void 0 : s.decorators) != null ? _a : a.decorators;
...
`);
      ...
      function Fe(a) {
        ...
        return Be = Fe.prototype = a != null ? a : /* @__PURE__ */ Object.create(null), new Fe();
      }
      var Ga = 10;
      for (let a = 0; a <= Ga; a++)
        Fe();
      ...
      function hn({ isExpression: a = false, optionsCombinations: t }) {
        return (e, s = {}) => {
          ...
          let i = t;
          ((_a = s.__babelSourceType) != null ? _a : Si(s)) === "script" && (i = i.map((l) => ({ ...l, sourceType: "script" }))), /#[[{]/.test(e) && (i = i.map((l) => R([rn], l)));
          let n = /%[A-Z]/.test(e);
